 ...
 **/
class VGCOMMSHARED_EXPORT MAVLinkProtocol : public QObject
{
    Q_OBJECT

public:
    explicit MAVLinkProtocol(LinkManager* linkMgr);
    ~MAVLinkProtocol();
...
public slots:
    ...
    /** @brief Set the Component id of this application */
...
#ifndef __mobile__
    void _startLogging(const QString& filename);
