...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_NAV_RALLY_POINT=5100, /* Rally point. You can have multiple rally points defined.
         |Reserved| Reserved| Reserved| Reserved| Latitude| Longitude| Altitude|  */
   MAV_CMD_NAV_OBSTACLE_POINT=5190, /* Obtacle boundary point. You can have multiple rally points defined.
         |Reserved| Reserved| Reserved| Reserved| Latitude| Longitude| Altitude|  */
   ...
   MAV_CMD_VAGA_TEST=31020, /* Viga test command for the motor and spray |User defined| User defined| User defined| User defined| User defined| User defined| User defined|  */
   MAV_CMD_SET_START_POINT=31100, /* Viga set the start assist point |PointNum| User defined| User defined| User defined| Latitude| Longitude| Altitude|  */
   MAV_CMD_GET_START_POINT=31101, /* Viga get the end assist point |PointNum| Reserved| Reserved| Reserved| Reserved| Reserved| Reserved|  */
   MAV_CMD_SET_END_POINT=31102, /* Viga set the end assist point |PointNum| User defined| User defined| User defined| Latitude| Longitude| Altitude|  */
   MAV_CMD_GET_END_POINT=31103, /* Viga get the end assist point |PointNum| Reserved| Reserved| Reserved| Reserved| Reserved| Reserved|  */
   MAV_CMD_CHK_ROUTE_POINT=31110, /* Viga check the path route point state |VehicleMode| PathGenState| Reserved| Reserved| Reserved| Reserved| Reserved|  */
   MAV_CMD_ENUM_END=31111, /*  | */
} MAV_CMD;
#endif
...
typedef enum MAV_PROTOCOL_CAPABILITY
{
   ...
   MAV_PROTOCOL_CAPABILITY_MISSION_OBSTACLE=131072, /* Autopilot supports mission obstacle boundary point protocol. | */
   MAV_PROTOCOL_CAPABILITY_MISSION_AOBPATH=262144, /* Autopilot supports mission avoid obstacle route path point protocol. | */
...
typedef enum MAV_MISSION_TYPE
{
   ...
   MAV_MISSION_TYPE_OBSTACLE=3, /* Specifies the obstacle area. obstacle points are the obstacle boundary points. Items are MAV_CMD_RALLY_POINT rally point items. | */
   MAV_MISSION_TYPE_AOBPATH=4, /* Specifies the obstacle area. obstacle points are the obstacle boundary points. Items are MAV_CMD_RALLY_POINT rally point items. | */
...
/** @brief  */
#ifndef HAVE_ENUM_MAV_QX_ACC_CMD
#define HAVE_ENUM_MAV_QX_ACC_CMD
typedef enum MAV_QX_ACC_CMD
{
   MAV_QX_ACC_CMD_READ=0, /* read qx acc and pswd | */
   MAV_QX_ACC_CMD_CLEAR=1, /* clear qx acc and pswdCS | */
   MAV_QX_ACC_CMD_ENUM_END=2, /*  | */
} MAV_QX_ACC_CMD;
#endif
...
#include "./mavlink_msg_spray_value.h"
...
#include "./mavlink_msg_assist_position.h"
#include "./mavlink_msg_viga_event.h"
#include "./mavlink_msg_qx_account.h"
#include "./mavlink_msg_qx_acc_cmd.h"
