...
typedef struct __mavlink_gps_raw_int_t {
 ...
 uint32_t hdg_acc; /*< [mm] Heading / track uncertainty in degrees * 1e5.*/
 ...
 * @param hdg_acc [mm] Heading / track uncertainty in degrees * 1e5.
 ...
 *
 * @return [mm] Heading / track uncertainty in degrees * 1e5.
 */
