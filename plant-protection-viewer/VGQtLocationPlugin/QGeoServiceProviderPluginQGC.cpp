...
//-----------------------------------------------------------------------------
const QT_PREPEND_NAMESPACE(QStaticPlugin) qt_static_plugin_VGGeoServiceProviderFactory()
{
...
VGGeoServiceProviderFactory::createGeocodingManagerEngine(
...
VGGeoServiceProviderFactory::createMappingManagerEngine(
    const QVariantMap &parameters, QGeoServiceProvider::Error *error, QString *errorString) const
{
...
VGGeoServiceProviderFactory::createRoutingManagerEngine(
...
//-----------------------------------------------------------------------------
QPlaceManagerEngine*
VGGeoServiceProviderFactory::createPlaceManagerEngine(
    const QVariantMap &, QGeoServiceProvider::Error *, QString *) const
{
    // Not implemented for QGC
    return NULL;
